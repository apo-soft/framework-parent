...
public class JavaMailWithAttachment {
	...
	public JavaMailWithAttachment(boolean debug) {
		InputStream in = JavaMailWithAttachment.class.getClassLoader().getResourceAsStream("MailServer.properties");
	...
	public void doSendHtmlEmail(String subject, String sendHtml, String receiverName, String receiverMail,
			File attachment) {
		try {
			String sender = String.format("%s<%s>", MimeUtility.encodeWord("刘健"), sender_username);
	...
	public static void main(String[] args) {
		...
		File affix = new File("D:\\home\\nginx_www\\index.html");
		se.doSendHtmlEmail("邮件主题", "邮件内容", "刘健", "pleasantboy@qq.com", affix);
	}
}
