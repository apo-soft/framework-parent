package org.quartz.jobstore.mongodb.demo;
 ...
 *
 */
public class QuartzJobStoreMongoExample {
	/**
	 * 运行实际动作
	 */
	public void run() {
		Logger log = LoggerFactory.getLogger(QuartzJobStoreMongoExample.class);
	...
	public static void main(String[] args) {
		new QuartzJobStoreMongoExample().run();
	}
}
